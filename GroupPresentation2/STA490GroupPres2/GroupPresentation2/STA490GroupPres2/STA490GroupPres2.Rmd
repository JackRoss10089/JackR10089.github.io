...
<h1 align = "center">Cluster Sample</h1>

The population is divided into distinct and homogeneous clusters

Clusters are randomly selected then all units in the clusters are considered for the sample

<div style="text-align: middle;">
  <img src="img/clusterexample.png" width=650 height=325;">
</div>
...
All four previously mentioned sampling methods will be tested
...
class:inverse middle center
name:sampling results
<h1 style="font-size: 40px; color: white; font-weight: bold;">Cluster Sample Results</h1>
    <table border="1"> <!-- Add border="1" to display borders -->
        <tr>
            <th>Region</th>
            <th>Status Unknown</th>
